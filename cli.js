...
const { booleans, transforms, geometries } = require("@jscad/modeling")
...
const Side_Plate = (thickness, radius) =>
  cylinder(thickness, radius, { center: false })
...
const main = () => {
  return Assembly(example_config)
}
